...
trait MethodsTrait
{
    ...
    public function specific_view_test($model_name): string
    {
        ...
        $str .= "\tget(route('show-{$this->str_to_lower($this->pluralize($model_name))}', ['id' => \${$this->str_to_lower($this->singularize($model_name))}->id]))->assertOk();" . PHP_EOL;
        $str .= "});" . PHP_EOL;
        return $str;
    }
    ...
    public function edit_form_test($model_name): string
    {
        ...
        $str .= "\t\${$this->str_to_lower($this->singularize($model_name))} = {$model_name}::first();" . PHP_EOL;
        $str .= "\tget(route('edit-{$this->str_to_lower($this->pluralize($model_name))}', ['id' => \${$this->str_to_lower($this->singularize($model_name))}->id]))->assertOk();" . PHP_EOL;
        $str .= "});" . PHP_EOL;
        return $str;
    }
    ...
    public function create_form_test($model_name): string
    {
        ...
        $str .= "\tget(route('create-{$this->str_to_lower($this->pluralize($model_name))}'))->assertOk();" . PHP_EOL;
        $str .= "});" . PHP_EOL;
        return $str;
    }
    ...
    public function saving_test($model_name, $fields): string
    {
        ...
        $str .= "\t\$response = post(route('store-{$this->str_to_lower($this->pluralize($model_name))}'), \$postData);" . PHP_EOL;
        $str .= "\t\$response->assertRedirect();" . PHP_EOL;
        $str .= "\t\$response->assertSessionHas('success', 'Post Created Successfully');" . PHP_EOL . PHP_EOL;
        ...
        $str .= "\t\$response->assertSessionHas('success', 'Post Created Successfully');" . PHP_EOL;
    ...
    public function deleting_test($model_name): string
    {
        ...
        $str .= "\t\$response->assertRedirect();" . PHP_EOL;
        $str .= "\t\$response->assertSessionHas('success', '{$model_name} Deleted Successfully');" . PHP_EOL;
        $str .= "\texpect({$model_name}::find(\${$this->str_to_lower($this->singularize($model_name))}->id))->toBeNull();" . PHP_EOL;
        $str .= "});" . PHP_EOL;
        return $str;
    }
    ...
    {
        $test_name = $this->singularize($model_name) . 'Tests';
